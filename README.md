## 👋 Welcome to calibre-web 🚀

Web application for browsing, reading and downloading eBooks
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/calibre-web/main/docker-compose.yaml" -o compose.yml
```
